...
export class WaveFrontRouter extends ethereum.SmartContract {
  static bind(address: Address): WaveFrontRouter {
    return new WaveFrontRouter("WaveFrontRouter", address);
  }
